...
org=codedesignplus
key=CodeDesignPlus.Net.Exceptions.Key
csproj=tests/CodeDesignPlus.Net.Exceptions.Test/CodeDesignPlus.Net.Exceptions.Test.csproj
report=tests/CodeDesignPlus.Net.Exceptions.Test/coverage.opencover.xml
