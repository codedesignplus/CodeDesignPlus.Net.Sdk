...
org=codedesignplus
key=CodeDesignPlus.Net.EventStore.Key
csproj=tests/CodeDesignPlus.Net.EventStore.Test/CodeDesignPlus.Net.EventStore.Test.csproj
report=tests/CodeDesignPlus.Net.EventStore.Test/coverage.opencover.xml
