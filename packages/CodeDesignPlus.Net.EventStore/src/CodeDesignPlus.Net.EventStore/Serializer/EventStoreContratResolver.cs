...
public class EventStoreContratResolver : DefaultContractResolver
{
    ...
    public EventStoreContratResolver()
    {
    ...
    public EventStoreContratResolver(string[] propertyNamesToIgnore)
    {
