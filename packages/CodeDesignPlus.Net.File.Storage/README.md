...
<br />
<p align="center">
  <a href="https://github.com/codedesignplus/CodeDesignPlus.Net.File.Storage/README">
    <img src="https://i.imgur.com/PwbGy0o.png" alt="Logo">
  </a>

  <h3 align="center">CodeDesignPlus.Net.File.Storage</h3>
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/codedesignplus/CodeDesignPlus.Net.File.Storage/issues">
      <img src="https://img.shields.io/github/issues/codedesignplus/CodeDesignPlus.Net.File.Storage?color=0088ff&style=for-the-badge&logo=github" alt="codedesignplus/CodeDesignPlus.Net.File.Storage's issues"/>
    </a>
    <a href="https://github.com/codedesignplus/CodeDesignPlus.Net.File.Storage/pulls">
      <img src="https://img.shields.io/github/issues-pr/codedesignplus/CodeDesignPlus.Net.File.Storage?color=0088ff&style=for-the-badge&logo=github"  alt="codedesignplus/CodeDesignPlus.Net.File.Storage's pull requests"/>
    </a>
    <br />    
    <br />
    <img alt="sonarcloud" src="https://sonarcloud.io/images/project_badges/sonarcloud-white.svg" width="100">
    <br />
    <img alt="Quality Gate Status" src="https://sonarcloud.io/api/project_badges/measure?project=CodeDesignPlus.Net.File.Storage.Key&metric=alert_status" />    
    <img alt="Security Rating" src="https://sonarcloud.io/api/project_badges/measure?project=CodeDesignPlus.Net.File.Storage.Key&metric=security_rating"/>
    <img alt="Reliability Rating" src="https://sonarcloud.io/api/project_badges/measure?project=CodeDesignPlus.Net.File.Storage.Key&metric=reliability_rating" />
    <img alt="Vulnerabilities" src="https://sonarcloud.io/api/project_badges/measure?project=CodeDesignPlus.Net.File.Storage.Key&metric=vulnerabilities" />
    <img alt="Bugs" src="https://sonarcloud.io/api/project_badges/measure?project=CodeDesignPlus.Net.File.Storage.Key&metric=bugs" />
    <img alt="Code Smells" src="https://sonarcloud.io/api/project_badges/measure?project=CodeDesignPlus.Net.File.Storage.Key&metric=code_smells" />
    <img alt="Coverage" src="https://sonarcloud.io/api/project_badges/measure?project=CodeDesignPlus.Net.File.Storage.Key&metric=coverage" />
  </p>
</p>
...
Refer to [issues](https://github.com/codedesignplus/CodeDesignPlus.Net.File.Storage/issues) for a list of proposed features and known issues.
...
Project Link: [CodeDesignPlus.Net.File.Storage](https://github.com/codedesignplus/CodeDesignPlus.Net.File.Storage)
