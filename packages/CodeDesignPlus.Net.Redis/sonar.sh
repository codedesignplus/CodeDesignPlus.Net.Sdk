...
org=codedesignplus
key=CodeDesignPlus.Net.Redis.Key
csproj=tests/CodeDesignPlus.Net.Redis.Test/CodeDesignPlus.Net.Redis.Test.csproj
report=tests/CodeDesignPlus.Net.Redis.Test/coverage.opencover.xml
