...
org=codedesignplus
key=CodeDesignPlus.Net.Kafka.Key
csproj=tests/CodeDesignPlus.Net.Kafka.Test/CodeDesignPlus.Net.Kafka.Test.csproj
report=tests/CodeDesignPlus.Net.Kafka.Test/coverage.opencover.xml
