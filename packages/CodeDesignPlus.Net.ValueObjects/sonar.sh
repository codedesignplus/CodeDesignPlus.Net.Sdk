...
org=codedesignplus
key=CodeDesignPlus.Net.ValueObjects.Key
csproj=tests/CodeDesignPlus.Net.ValueObjects.Test/CodeDesignPlus.Net.ValueObjects.Test.csproj
report=tests/CodeDesignPlus.Net.ValueObjects.Test/coverage.opencover.xml
