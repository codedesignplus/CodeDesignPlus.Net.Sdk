...
org=codedesignplus
key=CodeDesignPlus.Net.gRpc.Clients.Key
csproj=tests/CodeDesignPlus.Net.gRpc.Clients.Test/CodeDesignPlus.Net.gRpc.Clients.Test.csproj
report=tests/CodeDesignPlus.Net.gRpc.Clients.Test/coverage.opencover.xml
