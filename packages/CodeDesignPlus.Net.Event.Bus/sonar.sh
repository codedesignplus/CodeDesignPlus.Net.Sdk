...
org=codedesignplus
key=CodeDesignPlus.Net.Event.Bus.Key
csproj=tests/CodeDesignPlus.Net.Event.Bus.Test/CodeDesignPlus.Net.Event.Bus.Test.csproj
report=tests/CodeDesignPlus.Net.Event.Bus.Test/coverage.opencover.xml
