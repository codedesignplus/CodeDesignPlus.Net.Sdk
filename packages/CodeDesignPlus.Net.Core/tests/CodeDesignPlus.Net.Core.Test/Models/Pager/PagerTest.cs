...
using CodeDesignPlus.Net.Core.Test.Helpers.Context;
...
namespace CodeDesignPlus.Net.Core.Test.Models.Pager
{
    ...
    public class PagerTest
    {
        ...
        /// <summary>
        /// Valida la paginaci�n cuando esta se encuentra cerca al inicio
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Valida la paginaci�n cuando esta se encuentra cerca al final
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Valida la paginaci�n cuando esta se encuentra en la mitad
        /// </summary>
        [Fact]
