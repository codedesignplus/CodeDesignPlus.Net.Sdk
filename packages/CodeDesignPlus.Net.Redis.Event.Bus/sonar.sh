...
org=codedesignplus
key=CodeDesignPlus.Net.Redis.Event.Bus.Key
csproj=tests/CodeDesignPlus.Net.Redis.Event.Bus.Test/CodeDesignPlus.Net.Redis.Event.Bus.Test.csproj
report=tests/CodeDesignPlus.Net.Redis.Event.Bus.Test/coverage.opencover.xml
