...
org=codedesignplus
key=CodeDesignPlus.Net.Event.Sourcing.Key
csproj=tests/CodeDesignPlus.Net.Event.Sourcing.Test/CodeDesignPlus.Net.Event.Sourcing.Test.csproj
report=tests/CodeDesignPlus.Net.Event.Sourcing.Test/coverage.opencover.xml
