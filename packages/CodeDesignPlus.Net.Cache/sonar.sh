...
org=codedesignplus
key=CodeDesignPlus.Net.Cache.Key
csproj=tests/CodeDesignPlus.Net.Cache.Test/CodeDesignPlus.Net.Cache.Test.csproj
report=tests/CodeDesignPlus.Net.Cache.Test/coverage.opencover.xml
