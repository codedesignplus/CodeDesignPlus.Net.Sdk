...
org=codedesignplus
key=CodeDesignPlus.Net.EventStore.PubSub.Key
csproj=tests/CodeDesignPlus.Net.EventStore.PubSub.Test/CodeDesignPlus.Net.EventStore.PubSub.Test.csproj
report=tests/CodeDesignPlus.Net.EventStore.PubSub.Test/coverage.opencover.xml
