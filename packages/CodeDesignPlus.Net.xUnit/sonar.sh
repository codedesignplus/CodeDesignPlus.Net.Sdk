...
org=codedesignplus
key=CodeDesignPlus.Net.xUnit.Key
csproj=tests/CodeDesignPlus.Net.xUnit.Test/CodeDesignPlus.Net.xUnit.Test.csproj
report=tests/CodeDesignPlus.Net.xUnit.Test/coverage.opencover.xml
