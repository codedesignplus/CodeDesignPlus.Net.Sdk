...
public interface IRepositoryBase
{
    ...
    Task<bool> ExistsAsync<TEntity>(Guid id, CancellationToken cancellationToken)
        where TEntity : class, IEntityBase;
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>A task that represents the asynchronous existence operation.</returns>
    Task<bool> ExistsAsync<TEntity>(Guid id, Guid tenant, CancellationToken cancellationToken)
        where TEntity : class, IEntityBase;
