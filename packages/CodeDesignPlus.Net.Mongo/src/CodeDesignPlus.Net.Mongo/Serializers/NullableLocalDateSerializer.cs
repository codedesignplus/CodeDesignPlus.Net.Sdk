...
/// <summary>
/// Serializes <see cref="Nullable{LocalDate}"/> to/from BSON. Supports null, String (ISO format), DateTime, and Document representations.
/// </summary>
public class NullableLocalDateSerializer : SerializerBase<LocalDate?>
{
    ...
    public override void Serialize(BsonSerializationContext context, BsonSerializationArgs args, LocalDate? value)
    {
        ...
        context.Writer.WriteString(IsoPattern.Format(value.Value));
    }
    ...
    private static LocalDate? ReadNull(BsonDeserializationContext context)
    {
