...
org=codedesignplus
key=CodeDesignPlus.Net.PubSub.Key
csproj=tests/CodeDesignPlus.Net.PubSub.Test/CodeDesignPlus.Net.PubSub.Test.csproj
report=tests/CodeDesignPlus.Net.PubSub.Test/coverage.opencover.xml
