...
namespace CodeDesignPlus.Net.PubSub.Abstractions
{
    ...
    public interface ISubscriptionManager
    {
        ...
        string GetEventKey<TEvent>() where TEvent : IDomainEvent;
        /// <summary>
        ...
        bool HasSubscriptionsForEvent<TEvent>() where TEvent : IDomainEvent;
        ...
        IEnumerable<Subscription> GetHandlers<TEvent>() where TEvent : IDomainEvent;
        /// <summary>
