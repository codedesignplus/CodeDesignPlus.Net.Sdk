...
public class EventNotExistException : Exception
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EventNotExistException"/> class with a specified error message.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EventNotExistException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
    /// </summary>
    /// <param name="message">The error message.</param>
