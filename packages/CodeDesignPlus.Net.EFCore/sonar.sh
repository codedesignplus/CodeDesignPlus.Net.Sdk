...
org=codedesignplus
key=CodeDesignPlus.Net.EFCore.Key
csproj=tests/CodeDesignPlus.Net.EFCore.Test/CodeDesignPlus.Net.EFCore.Test.csproj
report=tests/CodeDesignPlus.Net.EFCore.Test/coverage.opencover.xml
