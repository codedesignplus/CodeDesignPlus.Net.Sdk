...
org=codedesignplus
key=CodeDesignPlus.Net.ServiceBus.Key
csproj=tests/CodeDesignPlus.Net.ServiceBus.Test/CodeDesignPlus.Net.ServiceBus.Test.csproj
report=tests/CodeDesignPlus.Net.ServiceBus.Test/coverage.opencover.xml
