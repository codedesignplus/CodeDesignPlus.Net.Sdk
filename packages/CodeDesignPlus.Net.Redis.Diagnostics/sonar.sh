...
org=codedesignplus
key=CodeDesignPlus.Net.Redis.Diagnostics.Key
csproj=tests/CodeDesignPlus.Net.Redis.Diagnostics.Test/CodeDesignPlus.Net.Redis.Diagnostics.Test.csproj
report=tests/CodeDesignPlus.Net.Redis.Diagnostics.Test/coverage.opencover.xml
