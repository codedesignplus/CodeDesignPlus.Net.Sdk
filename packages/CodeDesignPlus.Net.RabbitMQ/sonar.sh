...
org=codedesignplus
key=CodeDesignPlus.Net.RabbitMQ.Key
csproj=tests/CodeDesignPlus.Net.RabbitMQ.Test/CodeDesignPlus.Net.RabbitMQ.Test.csproj
report=tests/CodeDesignPlus.Net.RabbitMQ.Test/coverage.opencover.xml
